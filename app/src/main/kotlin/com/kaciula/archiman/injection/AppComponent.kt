...
import com.kaciula.archiman.infrastructure.InfrastructureModule
import dagger.Component
import javax.inject.Singleton

@Singleton
@Component(modules = arrayOf(AppModule::class, DataModule::class, PrefsModule::class, RemoteModule::class,
        DataRepositoryModule::class, DomainModule::class, InfrastructureModule::class))
